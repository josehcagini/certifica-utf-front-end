...
export default function CriarCertificado({ setIsValidData, eventObject, register }) {
    ...
    return (
        <div className={styles.content}>
            <div className={styles.leftContent}>
                ...
                <Input name="importarXML" type="file" title="Importar XML" width="fit-content" accept=".xml" />
